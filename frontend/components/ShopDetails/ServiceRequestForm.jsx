...
import { faTimes, faTruckPickup, faCar, faInfoCircle, faCamera, 
                ...
                <div className="grid grid-cols-3 gap-3">
                    {[
                        ...
                        <button
                            ...
                            className={`py-3 px-2 flex flex-col items-center justify-center rounded-xl border-2 transition-all duration-200 ${
                                vehicleCategory === type.id
                ...
                <div className="flex flex-wrap gap-2">
                    {[
                        ...
                        <button
                            ...
                            className={`px-4 py-2 rounded-xl border flex items-center gap-2 text-[12px] font-bold transition-all duration-200 ${
